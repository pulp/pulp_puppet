...
# Test Directories
TESTS="pulp_puppet_common/test/unit"
TESTS=$TESTS" pulp_puppet_extensions_admin/test/unit"
TESTS=$TESTS" pulp_puppet_extensions_consumer/test/unit"
TESTS=$TESTS" pulp_puppet_handlers/test/unit"
TESTS=$TESTS" pulp_puppet_plugins/test/unit"
